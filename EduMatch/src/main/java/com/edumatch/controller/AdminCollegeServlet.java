/**
 * AdminCollegeServlet - Handles HTTP requests for college management operations
 * Provides CRUD operations for college information including create, read, update, and delete functionality
 * Supports both GET and POST requests for managing college data
 */
